...
emotionView model =
    div [ Html.Attributes.class "h-100" ]
        [ Html.form [ Html.Attributes.class "h-100 flex flex-column", onSubmit EmotionSubmit ]
            [ label [ Html.Attributes.class "vh", for "mood" ]
                [ Html.text "Mood" ]
            , div [ Html.Attributes.class "flex flex-1 justify-between" ]
                [ div [ Html.Attributes.class "relative flex items-center h-100" ]
                    [ input [ Html.Attributes.class "rotate-270", Html.Attributes.id "mood", onInput Mood, Html.Attributes.max "10", Html.Attributes.min "0", value model.current.mood, Html.Attributes.type_ "range" ] []
                    , div [ Html.Attributes.class "absolute top-1 w4 pv2 white bg-gray tc br2" ]
                        [ Html.text "Good" ]
                    , div [ Html.Attributes.class "absolute bottom-1 w4 pv2 white bg-gray tc br2" ]
                        [ Html.text "Bad" ]
                    ]
                , div [ Html.Attributes.class "relative flex items-center h-100" ]
                    [ input [ Html.Attributes.class "rotate-270", Html.Attributes.id "energy", onInput Energy, Html.Attributes.max "10", Html.Attributes.min "0", value model.current.energy, Html.Attributes.type_ "range" ] []
                    , div [ Html.Attributes.class "absolute top-1 w4 pv2 white bg-gray tc br2" ]
                        [ Html.text "Good" ]
                    , div [ Html.Attributes.class "absolute bottom-1 w4 pv2 white bg-gray tc br2" ]
                        [ Html.text "Bad" ]
            ...
            , label [ Html.Attributes.class "vh", for "energy" ]
                [ Html.text "Energy" ]
            , button [ Html.Attributes.class "grow bn ph3 pv2 white bg-blue db w-100", Html.Attributes.type_ "submit" ]
                [ Html.text "Submit" ]
            ]
        ]
