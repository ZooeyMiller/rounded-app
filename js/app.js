...
var _user$project$Main$recordMood = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$for('mood'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Mood'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('mood'),
						_1: {
							ctor: '::',
		...
		switch (_p0.ctor) {
			...
			case 'Submit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl('#/mood')
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {username: a, password: b, location: c};
	});
var _user$project$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: A3(_user$project$Main$Model, '', '', location),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _user$project$Main$chooseView = function (model) {
	var _p1 = model.location.hash;
	switch (_p1) {
		case '':
			return _user$project$Main$loginForm(model);
		case '#/mood':
			return _user$project$Main$recordMood(model);
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('you\'re not supposed to be here'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$chooseView(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.location.pathname),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
